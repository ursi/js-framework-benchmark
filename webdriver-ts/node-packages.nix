...
let
  sources = {
    ...
    "chromedriver-87.0.0" = {
      ...
      version = "87.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/chromedriver/-/chromedriver-87.0.0.tgz";
        sha512 = "PY7FnHOQKfH0oPfSdhpLx5nEy5g4dGYySf2C/WZGkAaCaldYH8/3lPPucZ8MlOCi4bCSGoKoCUTeG6+wYWavvw==";
      };
    };
    "ci-info-2.0.0" = {
      name = "ci-info";
